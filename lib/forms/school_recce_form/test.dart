...
class _GradeEnrollmentScreenState extends State<GradeEnrollmentScreen> {
  ...
  final List<bool> isSelected = List.generate(10, (index) => false); // 10 grades
                ...
                return CheckboxListTile(
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      } else if (!isSelected[index] && grades.contains(gradeName)) {
                ...
                child: Table(
                  ...
                  children: [
                    TableRow(
                      children: [
                        const TableCell(
                          child: Center(child: Text('Class Name', style: TextStyle(fontWeight: FontWeight.bold))),
                        ),
                        const TableCell(
                          child: Center(child: Text('Boys', style: TextStyle(fontWeight: FontWeight.bold))),
                        ),
                        const TableCell(
                          child: Center(child: Text('Girls', style: TextStyle(fontWeight: FontWeight.bold))),
                        ),
                        const TableCell(
